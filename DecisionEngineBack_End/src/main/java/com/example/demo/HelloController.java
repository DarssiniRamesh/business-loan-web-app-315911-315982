package com.example.DecisionEngineBackEnd;
...
@RestController
@Tag(name = "Hello Controller", description = "Basic endpoints for DecisionEngineBackEnd")
public class HelloController {
    
    @GetMapping("/")
    @Operation(summary = "Welcome endpoint", description = "Returns a welcome message")
    public String hello() {
        return "Hello, Spring Boot! Welcome to DecisionEngineBackEnd";
    }
    ...
    public String info() {
        return "Spring Boot Application: DecisionEngineBackEnd";
    }
} 